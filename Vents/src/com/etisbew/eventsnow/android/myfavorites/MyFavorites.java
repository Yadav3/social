...
public class MyFavorites extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		no_ticket = (RelativeLayout) findViewById(R.id.no_ticket); 
 		back_home_button = (TextView) findViewById(R.id.back_home_button); 
 		back_home_button.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent(MyFavorites.this,MainActivity.class));
	...
	public void update() {
		if(id.size()>0){
			...
			//util.dialogExample1("No events added to your account");
