...
public class SplashActivity extends Activity {
				...
				dialog.setNegativeButton("Cancel",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(
									...
									int paramInt) {
								// TODO Auto-generated method stub
								//setting default latitue and longitude 
								latitude = 17.3939;
								longitude = 78.4677;
	...
	//Getting events by depending upon city 
	...
	//Getting Categories depending upon city name
					...
					while (eventType != XmlPullParser.END_DOCUMENT) {
						...
						case XmlPullParser.START_TAG:
							...
							if (name.equalsIgnoreCase(CATEGORYRESPONSE)) {
								...
								if (name.equalsIgnoreCase(ID)) {
									category_id.add(Integer.parseInt(parser.nextText()));
								} else if (name.equalsIgnoreCase(TITLE)) {
	...
	public void Getting_Events_Update() {
