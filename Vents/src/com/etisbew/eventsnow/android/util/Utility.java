...
/*	String baseUrl1 = "http://enowdev.etg.net/Webservices2/"; 
	...
	String baseUrl3 = "http://enowdev.etg.net/";*/   
    
	//live    
	 
	String baseUrl1 = "http://www.eventsnow.com/Webservices2/";  
	String baseUrl2 = "http://www.eventsnow.com/WebServices3/";     
	String baseUrl3 = "http://www.eventsnow.com/";   
	    
	/*public String setFutureEvents() {  
		String f_events = baseUrl1+ "GetFeaturedEvents/getxmlFeaturedEvents.xml";
		return f_events;  

	}//http://www.happeninghyderabad.com/webservices/getLocations.xml
*/	public String setLocations() {
		String locations = baseUrl1+ "getLocations/test.xml"; 
		return locations;   
	...
	//http://enowdev.etg.net/WebServices3/sendSingleTicket/gg.xml?ticketid=17254&bookingid=157126
	public String sendEmail(String booking_id,int ticket_id) {
		String send_email = baseUrl2 + "sendSingleTicket/gg.xml?ticketid="+ticket_id+"&bookingid="+booking_id;
		return send_email;  
	...
	public String setAuthenticate(int transaction_id) {
		...
		String service = baseUrl3 + "transactions/econfirm/"+transaction_id+"?mobile=1";
		return service;  

	}
	public String setEvents(String category_id,int location_id) {
		String events = baseUrl1 + "FilteredEvents/"+category_id+"/"+location_id+"/sd.xml";
		return events;  
	...
	public String setPrintTicket(String ticketid,String email) {
		String pticket =baseUrl2+ "printTicket/"+ticketid+"/"+email;
		return pticket;
   
	} 
	public String setNotifyme(int eventid,String email) {
		String notify =baseUrl2+ "notifyMe/"+eventid+"/"+email;
		return notify;
	...
	public String setAbout() {
		String events_details = baseUrl1 + "pages/AboutUs/pages.xml";
		return events_details;
...
*/		}
	public String setContact(String fname,String lastname,String city,String country,String email,String gender,String phone,String requesttype,String message) {
		String events_details = baseUrl1 + "PostFeedback/test.xml?"+"firstname="+fname+"&"+"lastname="+lastname+"&"+"city="+city+"&"+"country="+country+"&"+"email="+email+"&"+"gender="+gender+"&"+"phone="+phone+"&"+"requesttype="+requesttype+"&"+"message="+message;
		return events_details;

	}
	//http://enowdev.etg.net/Webservices2/ContactOrganiser/test.xml

	public String setOrganizer() {
		String organizer =baseUrl1+"ContactOrganiser/test.xml";
		return organizer;
...
//			    String[] parts1 = parts[1].split("sai");
	...
	{  
	System.out.println("date1 & date2"+date1.getTime()+":"+date2.getTime()+"==="+(date1.getTime()-date2.getTime()));
